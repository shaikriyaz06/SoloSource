...
const AboutUs = () => {
  ...
  return (
    <div className="bg-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 h-full flex items-center">
          <div className="text-white max-w-3xl" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              We're more than just a technology company. We're your partner in digital transformation,
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-lg">
              Founded in 2010, we've been at the forefront of digital transformation, 
              helping businesses navigate the ever-evolving technology landscape. Our 
              journey began with a simple mission: to make cutting-edge technology 
              accessible to businesses of all sizes.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center p-6 bg-white rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="100">
                <h3 className="text-4xl font-bold text-blue-600 mb-2">500+</h3>
                <p className="text-gray-600">Projects Completed</p>
              </div>
              <div className="text-center p-6 bg-white rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="200">
                <h3 className="text-4xl font-bold text-blue-600 mb-2">200+</h3>
                <p className="text-gray-600">Happy Clients</p>
              </div>
              <div className="text-center p-6 bg-white rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg" 
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                that shape the future of business and technology.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-gray-800 mb-16 text-center" data-aos="fade-up">
            Our Core Values
          </h2>
